 ...
 */
static char *font = "Fira Code Nerd Tort:pixelsize=30:antialias=true:autohint=true";
static char *font2[] = {
	"Fira Code APL:pixelsize=30:antialias=true:autohint=true",
